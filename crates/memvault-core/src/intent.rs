...
const RULES: &[Rule] = &[
    Rule {
        ...
        keywords: &[
            "code", "coding", "program", "function", "class", "method", "bug", "fix",
            "refactor", "test", "debug", "compile", "build", "deploy", "api", "endpoint",
            "database", "sql", "query", "schema", "migration", "git", "commit", "branch",
            "merge", "pr", "pull request", "review", "lint", "format", "type", "interface",
            "struct", "enum", "trait", "impl", "async", "await", "error", "exception",
            "import", "module", "package", "dependency", "cargo", "npm", "pip",
            "python", "rust", "javascript", "typescript", "java", "go", "c++",
            "代码", "编程", "函数", "类", "方法", "调试", "编译", "构建", "部署",
            "接口", "数据库", "重构", "测试",
        ],
    ...
    Rule {
        ...
        keywords: &[
            "write", "writing", "article", "blog", "post", "essay", "document",
            "documentation", "readme", "changelog", "copy", "content", "draft",
            "edit", "proofread", "grammar", "tone", "style guide", "markdown",
            "文章", "写作", "文档", "博客", "草稿", "校对",
        ],
    ...
    Rule {
        ...
        keywords: &[
            "design", "architecture", "ui", "ux", "layout", "wireframe", "mockup",
            "component", "figma", "sketch", "color", "font", "responsive",
            "css", "style", "animation", "prototype",
            "设计", "架构", "布局", "原型", "组件",
        ],
    ...
    Rule {
        ...
        keywords: &[
            "research", "investigate", "analyze", "compare", "benchmark", "evaluate",
            "study", "survey", "review", "paper", "finding", "conclusion",
            "调研", "分析", "比较", "评估", "研究",
        ],
    ...
    Rule {
        ...
        keywords: &[
            "project", "milestone", "deadline", "sprint", "roadmap", "plan",
            "schedule", "timeline", "priority", "task", "issue", "ticket",
            "项目", "里程碑", "截止", "计划", "进度", "任务",
        ],
...
pub fn should_exclude_for_intent(intent: &Intent, memory_tags: &[String], exclude_types: &[String]) -> bool {
    ...
    for tag in memory_tags {
        ...
        if exclude_types.iter().any(|et| tag_lower.contains(&et.to_lowercase())) {
            return true;
        }
    }
